...
<table border="1" cellspacing="0" cellpadding="1">
	<tr>
 	...
 	<?php
			...
			$statement = $db->prepare("SELECT * FROM tdl_cost where month='$input_month' and year='$input_year' ORDER BY cost_id ASC");
			$statement->execute();
			...
			$statement = $db->prepare("SELECT *  FROM tdl_cost where month='$input_month' and year='$input_year' ORDER BY cost_id ASC LIMIT $start, $limit");
			$statement->execute();
 ...
 <td></td>
	<td>মোট ব্যায় :</td>
		<td>
		<?php 
			$query=$db->query("select SUM(tdl_cost_taka) as total_vara from tdl_cost where year='$input_year' and  month='$input_month'");
			$query->execute();
