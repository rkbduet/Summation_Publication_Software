...
if(isset($_REQUEST['tdl_no'])){
	...
	$password=$_REQUEST['password'];
		...
		if($num==0) 
		{
			...
			header("location:tdl_delete.php?error=1");
		}
	...
	header("location:tdl_delete.php?error=0");
}
...
<div id="main_form">
	...
	<table cellspacing="0" cellpadding="2">
		...
		<h1 class="center">
		<a class="btn btn-danger" onclick="return confirm_delete();" href="treadlisence_delete.php?id=<?php echo $row['app_serial']; ?>"> মুছে ফেলুন</a>
		</h1>
