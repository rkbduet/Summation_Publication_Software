...
if(empty($_POST['data_entry_kari_post'])) {
		...
		if(($file_ext!='.png')&&($file_ext!='.jpg')&&($file_ext!='.jpeg')&&($file_ext!='.gif'))
 {
		...
		$query=$db->prepare("update tred_lisence_application set app_name=?,app_f_name=?,app_m_name=?,b_name=?,b_address_vill=?,b_address_holding_no=?,b_address_word_no=?,b_address_post=?
		...
		app_tin_num=?,app_mobile=?,app_email=?,app_treadlisence_no=?,treadlisence_year=?,data_entry_name=?,app_photo=?,entry_post=? where app_id=?");
		$query->execute(array($_POST['applicate_name'],$_POST['f_name'],$_POST['m_name'],$_POST['b_name'],$_POST['b_vill'],$_POST['b_holding_no'],$_POST['b_word_no'],$_POST['b_post'],
		...
		$_POST['s_post'],$_POST['s_upzila'],$_POST['s_district'],$_POST['tin_number'],$_POST['mobile_number'],$_POST['email'],$_POST['treadlisence_number'],$_POST['treadlisence_year'],$_POST['data_entry_kari'],$f1,$_POST['data_entry_kari_post'],$id));
...
?>
<?php
		$query=$db->prepare("select * from tred_lisence_application where app_id='$id'");
		$query->execute();
...
<div class="container">
	...
	<div id="application_form">
		...
		<div class="row">
			<div class="col-lg-4"><label for="">আবেদনকারীর ছবিঃ</label></div>
			<div class="col-lg-3"><img src="img/applicate_image/<?php echo $row['app_photo']; ?>" alt="" width="150px" height="160px;"/></div>
			<div class="col-lg-5"><input type="file" name="photo"/></div>
		...
		<div class="row">
			...
			<div class="col-lg-3"><input type="text" name="data_entry_kari_post" value="<?php  echo $row['entry_post'];?>"  selected style="width:70%;"/></div>
