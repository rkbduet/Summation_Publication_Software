...
<div class="container">
<h2 class="title">  রশিদ প্রিন্ট করুন</h2>
    <?php  
...
<table celspacing="1" cellpadding="5"  style="color:red;">
	<tr>
	...
	<tr>
	<td></td>
					<td><button class="btn btn-info btn-large" name="form1" >প্রিন্ট</button></td>
				</tr>
