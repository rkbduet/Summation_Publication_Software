...
<div class="container">
<h2 class="title">করদাতার তথ্য  মুছেফেলুন </h2>
    <?php  
if(isset($error_message)) {echo "<div class='error_message'>".$error_message."</div>";}
?>
	
	<form action="app_view_data_for_delete.php" method="post" id="" >
			<table cellspacing="1" cellpadding="5">
				...
				<td></td>
					<td><button class="btn btn-success" name="form" >তথ্য মছুন</button></td>
				</tr>
