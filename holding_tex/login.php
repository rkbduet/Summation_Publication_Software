...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
		...
		<header>
			<div class="container">
				<div class="logo"><img src="../Pourosova.jpg" alt="Your Logo" class="logo"/></div>
				<h1> টাংগাইল পৌরসভা</h1>
				<h2>হোল্ডিং ট্যাক্স শাখা</h2>
...
if(isset($_POST['form_login'])) 
{
	...
	try {
		...
		$query = $db->prepare("select * from homepage_admin where  a_name=? and a_password=? and admin_id=3");
...
<div class="container"> 
<div class="heading">
<h2> হোল্ডিং টেক্স শাখার সফটওয়্যার ব্যবহার করার জন্য আপনাকে ধন্যবাদ </h2>
<h3>কারিগরি সহয়তায় টাংগাইল কলিং লিমিটেড</h2> 
</div>
