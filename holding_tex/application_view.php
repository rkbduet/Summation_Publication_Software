...
<div id="main_form">
	...
	<table cellspacing="0" cellpadding="2">
		...
		<tr>
			<td><label for="">গ্রাহকের চুক্তি পত্র (স্ক্যন কপি)ঃ</label></td>
			<td> <img src="img/scan/<?php echo $row['app_grahok_cokiti_p'];?>" alt="" width="100%" height="150px"/></td>
		...
		<tr>
			...
			<td><label for="">ডাটা এন্ট্রিকারীর নাম ও পদবীঃ</label></td>
	...
	<br />
		<a class="btn btn-danger" onclick="return confirm_delete();" href="delete.php?id=<?php echo $row['app_serial']; ?>"> মুছে ফেলুন</a>
