...
<div class="container">
<br>
<h2 class="title">Delete Client Information:</h2>
<?php  
if(isset($error_message)) {echo "<div class='error_message'>".$error_message."</div>";}
if(isset($success_message)) {echo "<div class='success_message'>".$success_message."</div>";}
?>
<br />
<form action="dokan_data_delete.php" method="post" >
...
<tr>
 ...
 <tr>
 	<td> Shop ID:</td>
	<td><input type="number" name="shop_id" id="" /></td>
</tr>

<tr>
	<td></td>
	<td><button class="btn btn-success" type="submit" name="form1">View Information</button></td>
</tr>
