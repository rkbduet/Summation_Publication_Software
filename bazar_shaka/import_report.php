...
<table border="1" cellspacing="0" cellpadding="1">
	<tr>
		...
		<th width="20%">Forma Size</th>
		<th width="15%">Press Name</th>
		<th width="10%">Num. Book</th>
		<th width="15%">Date</th>
 	...
 	<?php
			...
			$statement = $db->prepare("SELECT * FROM import ORDER BY import_id DESC");
			$statement->execute();
			...
			$statement = $db->prepare("SELECT * FROM import ORDER BY import_id DESC LIMIT $start, $limit");
			$statement->execute();
