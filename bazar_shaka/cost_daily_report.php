...
<table border="1" cellspacing="0" cellpadding="1">
	<tr>
 	...
 	<?php
			...
			$statement = $db->prepare("SELECT * FROM  cost where cost_date='$input_date' ORDER BY cost_id ASC");
			$statement->execute();
			...
			$statement = $db->prepare("SELECT * FROM cost where cost_date='$input_date' ORDER BY cost_id ASC LIMIT $start, $limit");
			$statement->execute();
 ...
 <td></td>
	<td>মোট ব্যায় :</td>
		<td>
		<?php 
			$query=$db->query("select SUM(cost_taka) as total_vara from cost where cost_date='$input_date'");
			$query->execute();
